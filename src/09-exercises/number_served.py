...
# Access attributes directly, through an instance.
restaurant.get_number_served()
restaurant.number_served = 2
restaurant.get_number_served()

# Access attribute indirectly, through a method (set new value).
...
# Access attribute indirectly, through a method (update value).
restaurant.increment_number_served(50)
restaurant.get_number_served()
restaurant.increment_number_served(0)
restaurant.get_number_served()
