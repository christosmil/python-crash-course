...
from settings_random import Settings
...
class SidewaysShooter:
    ...
    def _create_alien(self, alien_number, row_number):
        ...
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
        # Insert randomnes in each alien's position.
        # The alien can be left or right alien_width//2.
        # The alien can be over or below alien_height//2 
        # We use alien_width//2 and alien_width//2 to avoid overlapping.
        alien.x = (self.settings.screen_width
            - 2*alien_width*(alien_number+1) +
            randint(-alien_width//2, alien_width//2))
        alien.y = (alien_height + 4*alien_height*row_number +
            randint(-alien_height//2, alien_height//2))
        self.aliens.add(alien)

    def _move_fleet(self):
        """Move the entire fleet towards the ship."""
